...
photo = PhotoImage(file = "/Users/calebsmacbookpro/PycharmProjects/py_unit_eight/unit 8 images/number1.png")
img1 = photo.zoom(25)
...
calculate1 = tk.Button(button_frame1, text="1", image = photo, command=one)
